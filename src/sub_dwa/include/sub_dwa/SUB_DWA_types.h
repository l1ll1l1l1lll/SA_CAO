...
//
#ifndef RTW_HEADER_SUB_DWA_types_h_
#define RTW_HEADER_SUB_DWA_types_h_
#include "rtwtypes.h"
...
// Custom Type definition for MATLABSystem: '<S13>/SourceBlock'
...
typedef struct tag_RTM_SUB_DWA_T RT_MODEL_SUB_DWA_T;

#endif                                 // RTW_HEADER_SUB_DWA_types_h_
