...
#include "motion_msgs/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _MovementCtrlMode_type_support_symbol_names_t _MovementCtrlMode_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, motion_msgs, msg, MovementCtrlMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, motion_msgs, msg, MovementCtrlMode)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_motion_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, motion_msgs, msg, MovementCtrlMode)() {
  return &::motion_msgs::msg::rosidl_typesupport_c::MovementCtrlMode_message_type_support_handle;
}
